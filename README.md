...
| `influence-os` | The portable operating prompt that trains any AI on Eli Wilde's NLP for Sales principles, generalized past sales to negotiation, leadership, relationships, self-persuasion and writing, with the context intake, domain rules, failure conditions and ethics gate built in. `belief-patterns` stays the home for Joe's own copy; this is the version he pastes into a Project or a Custom GPT. | Copy and paste from `references/master-prompt.md`; Dropbox canonical if Joe wants it junctioned |
